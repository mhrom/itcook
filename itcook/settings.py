...
CKEDITOR_CONFIGS = {'default':{'toolbar':'basic','height': 400,'width': 900,},'small':{'toolbar':'basic', 'height': 50, 'width': 900} }

ADMINS = (('Mykola Hromivchuk', 'mhromivchuk@gmail.com'),)
...
TEMPLATE_DIRS = (os.path.join(BASE_DIR, 'templates'),os.path.join(BASE_DIR),)
